...
/**
 * By Richard on 2017/12/21.
 * 参考 https://github.com/Brooks0129/LoadMoreRecyclerView
 */
...
public class LoadMoreRecyclerView extends RecyclerView {
    ...
    private boolean usePicture=true;//是否使用图片动画作为进度条
                ...
                if (usePicture) {
                    return new FooterViewHolder(
                            LayoutInflater.from(parent.getContext()).inflate(
                                    R.layout.footer_use_pic,parent,false));
        ...
        public class FooterViewHolder extends ViewHolder {
            public FooterViewHolder(View itemView){
                ...
                if (usePicture) {
                    ...
                    image.setBackgroundResource(R.drawable.anim_load_more);
