...
//                .centerCrop()
    ...
    public void displayImage(String url, Context context, ImageView imageView) {
        displayImage(url, context, imageView, R.mipmap.icon_header_defalut, R.mipmap.icon_header_defalut);
    }
    ...
    public void displayAlbumImage(String url, Context context, ImageView imageView) {
        Glide.with(context)
                .load(url)
                .placeholder(R.mipmap.icon_header_defalut)
                .error(R.mipmap.icon_header_defalut)
                .fitCenter()
                .into(imageView);
    }
