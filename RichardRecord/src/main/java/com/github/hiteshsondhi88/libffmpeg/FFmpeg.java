...
public class FFmpeg implements FFmpegInterface {
    ...
    public static String cpuArchNameFromAssets="";
    ...
    public void loadBinary(FFmpegLoadBinaryResponseHandler ffmpegLoadBinaryResponseHandler) throws FFmpegNotSupportedException {
        ...
        //判断文件是否存在
//		if(!com.richard.record.utils.FileUtils.isFileExist("AppSetting.APP_FFMPEG+\"/\"+FFmpeg.cpuArchNameFromAssets+\"/\"+\"ffmpeg\"")){
//			throw new FFmpegNotSupportedException("Device not supported");
//		}

//        if(!com.richard.record.utils.FileUtils.isFileExist(context.getResources().getAssets())){
//            throw new FFmpegNotSupportedException("Device not supported");
//        }
